...
Question
==================
Which of the plots below shows that linearity is a reasonable assumption for a linear regression model?
...
For the assumption of linearity to be valid, we want to observe an even spread of points above and below the 0 line. 


Meta-information
================
exname: lm-linearity-plots
extype: schoice
