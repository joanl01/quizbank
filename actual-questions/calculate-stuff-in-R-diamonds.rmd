...
explanation <- switch(question,
                      "mean" = paste("To calculate the mean of the", variable, 
                                     "variable, use `mean(diamonds$", variable, ")`."),
                      "median" = paste("To calculate the median of the", variable, 
                                       "variable, use `median(diamonds$", variable, ")`."),
                      "standard deviation" = paste("To calculate the standard deviation of the", variable, 
                                                   "variable, use `sd(diamonds$", variable, ")`."),
                      "variance" = paste("To calculate the variance of the", variable, 
                                         "variable, use `var(diamonds$", variable, ")`."),
                      "kurtosis" = paste("To calculate the kurtosis of the", variable, 
                                         "variable, use `kurtosis(diamonds$", variable, ")`."),
                      "skewness" = paste("To calculate the skewness of the", variable, 
...
Which is the `r question` of the `r variable`? (Rounded to 4 decimal places)
