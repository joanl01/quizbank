...
plot2 <- penguins |> ggplot(aes(x = flipper_len, y = bill_len)) + geom_point() + 
  theme_minimal() + labs(x = "Flipper length",
                    y = "Bill length", 
                    title = "Plot 2")

plot1 <- penguins |> ggplot(aes(x = species, y = flipper_len)) + geom_boxplot() +
  theme_minimal() + labs(x = "Species",
                         y = "Flipper length", 
                         title = "Plot 1")

plot4 <- penguins |> ggplot(aes(x = sex, y = bill_len)) + geom_boxplot() + 
  theme_minimal() + labs(x = "Sex",
                         y = "Bill length", 
                         title = "Plot 4")

plot3 <- penguins |> ggplot(aes(x = bill_len)) + geom_histogram(col = "white", bins = 30) + 
