...
summary(model)
```
Now the researcher wants to know what is the 95% prediction interval for hard-working students that has studied for `r rand_hour` hours. Which R code correctly obtains the 95% prediction interval?
...
Solution
======================
To get the prediction interval, the `predict()` function must be used, where `newdata` must be a data frame, and `interval = "prediction"`. 
