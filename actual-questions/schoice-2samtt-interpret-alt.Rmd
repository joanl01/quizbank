...
if(tt$alternative != "two.sided"){
  sol <- c(TRUE, FALSE)
} else if(tt$alternative == "two.sided"){
  sol <- c(FALSE, TRUE)
}
...
Solution 
===============
The test aims at showing that the difference of means is `r switch(tt$alternative, "two.sided" = "unequal to", "less" = "smaller than", "greater" = "larger than")`  0.
