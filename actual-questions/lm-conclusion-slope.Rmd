...
choices <- character(4)
choices[1] <- "Study time has no effect on the GPA score"
choices[2] <- "There is insufficient evidence that study time affects GPA score"
choices[3] <- "There is a statistically significant effect of study time on GPA score"
choices[4] <- "The model predicts GPA scores perfectly"
...
summary(model)
```
Which is the correct conclusion about the slope at the 5% significance?
...
This means that `study_time` has `r ifelse(pval<0.05, "a", "no")` statistically significant effect on GPA. 
