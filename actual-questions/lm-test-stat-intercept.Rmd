...
summary(model)
```
What is the value of the test statistic used to test the intercept coefficeint? 
...
Solution
======================
 The test used to test the intercept coefficient is the t-test, whose test statistic can be found under the `t-value` column, and the row of the intercept (`(intercept)`).
