...
choices[1] <- paste0("For each additional hour studied, the average GPA score increases by ", slope)
choices[2] <- paste0("Students who study score ", slope, " points higher on average on their GPA")
choices[3] <- paste0("Every additional hour of study causes GPA score to increase by ", slope)
choices[4] <- paste0("GPA score increases by ", slope, " for every student")
sol <- c(T, F, F, F)
...
summary(model)
```
What does it mean for the model to have a slope of `r slope`?
...
exname: lm-interpret-slope-in-context
exshuffle: TRUE
